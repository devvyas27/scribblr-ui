    ...
    return Row(
      children: [
        ...
        GestureDetector(
          ...
          child: Chip(
            side: BorderSide(style: BorderStyle.solid, color: appColorPrimary),
            label: Text(
              _isSelected ? 'Following' : 'Follow',
              style: TextStyle(fontSize: 12, color: _isSelected ? appColorPrimary : Colors.white),
            ),
            backgroundColor: _isSelected ? context.scaffoldBackgroundColor : appColorPrimary,
