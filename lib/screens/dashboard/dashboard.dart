        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              ...
              activeIcon: Icon(Ionicons.home, color: appColorPrimary),
              label: 'Home',
            ),
            BottomNavigationBarItem(
              icon: Icon(
              ...
              activeIcon: Icon(Ionicons.compass, color: appColorPrimary),
              label: 'Discover',
            ),
            BottomNavigationBarItem(
              icon: Icon(
              ...
              activeIcon: Icon(Ionicons.add_circle, color: appColorPrimary),
              label: 'Create',
            ),
            BottomNavigationBarItem(
              icon: Icon(
              ...
              activeIcon: Icon(Ionicons.newspaper, color: appColorPrimary),
              label: 'My Articles',
            ),
            BottomNavigationBarItem(
              icon: Icon(
              ...
              activeIcon: Icon(Ionicons.person, color: appColorPrimary),
              label: 'Profile',
            ),
          ],
        ),
