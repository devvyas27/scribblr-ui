      ...
      children: [
        ...
        ElevatedButton(
          style: ButtonStyle(
            ...
            side: MaterialStateProperty.all(BorderSide(color: appColorPrimary)),
          ),
          onPressed: () {
          ...
          child: Row(
            children: [
              Icon(Icons.edit,
                  size: 14, color: appStore.isDarkModeOn ? scaffoldLightColor : appColorPrimary),
              Text('Edit',
                  style: TextStyle(color: appStore.isDarkModeOn ? scaffoldLightColor : appColorPrimary)),
            ],
          ),
        ),
      ],
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
            ...
            child: Text(label, style: TextStyle(color: appColorPrimary)),
          ),
        ],
      ),
    );
  ...
  Row buildSocialMediaRow(IconData icon, String label) {
    return Row(
      children: [
        ...
        5.width,
        Text(label, style: TextStyle(color: appColorPrimary)),
      ],
    );
  }
