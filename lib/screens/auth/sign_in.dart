            ...
            children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: Icon(_obscureText ? Icons.visibility : Icons.visibility_off, color: appColorPrimary),
                          onPressed: () {
                            setState(() {
              ...
              Center(
                child: TextButton(
                  ...
                  child: Text('Forgot Password', style: TextStyle(color: appColorPrimary, fontWeight: FontWeight.w500)),
                ),
              ),
              15.height,
              Row(
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text('Sign Up', style: TextStyle(color: appColorPrimary, fontWeight: FontWeight.w500)),
                  ),
                  CustomDivider(),
                ],
              ),
